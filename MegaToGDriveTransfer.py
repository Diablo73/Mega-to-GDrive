...
# @markdown <center><h3>Transfer from Mega to GDrive</h3></center><br>
...
if OUTPUT_PATH == "":
	OUTPUT_PATH = "/content/drive/MyDrive/Sharer"
# @markdown _Sometimes this cell doesn't stop itself after the completion of the transfer. In that case, stop the cell manually._
if not OUTPUT_PATH:
